...
- [x] 1. Add AdminRole enum and AdminUser model to Prisma schema
...
- [x] 2. Add AuditLog model to Prisma schema
  - File: `apps/api/prisma/schema.prisma`
...
- [x] 3. Add compound indexes to Scan model for admin queries
  - File: `apps/api/prisma/schema.prisma`
...
- [x] 4. Generate and run Prisma migration
...
- [x] 5. Create admin types file with TypeScript interfaces
...
- [x] 6. Create admin error class in admin service file
...
- [x] 7. Add admin Redis keys constants
...
- [x] 8. Create admin Zod validation schemas
...
- [x] 9. Create admin repository with user CRUD operations
...
- [x] 10. Implement admin service authentication methods
...
- [x] 11. Create admin JWT auth middleware
...
- [x] 12. Create login rate limit middleware
...
- [x] 13. Create auth controller with login endpoint
...
- [x] 14. Add logout and me endpoints to auth controller
...
- [x] 15. Add list and create admin user endpoints
  - File: `apps/api/src/modules/admin/admin.controller.ts` (extend)
...
- [x] 15b. Add update and deactivate admin user endpoints
  - File: `apps/api/src/modules/admin/admin.controller.ts` (extend)
...
- [x] 15c. Add password reset endpoint
  - File: `apps/api/src/modules/admin/admin.controller.ts` (extend)
...
- [x] 16. Register admin routes in Fastify
...
- [x] 17. Create scan admin service with list and filter methods
...
- [x] 18. Add scan delete and retry to scan admin service
...
- [x] 19. Create customer service with aggregation methods
...
- [x] 20. Add customer filter and export to customer service
...
- [x] 21. Add scan management endpoints to controller
  - File: `apps/api/src/modules/admin/admin.controller.ts` (extend)
...
- [x] 22. Add customer endpoints to controller
  - File: `apps/api/src/modules/admin/admin.controller.ts` (extend)
...
- [x] 23. Create dashboard service with metrics methods
...
- [x] 24. Add scan trends method to dashboard service
...
- [x] 24b. Add issue distribution and top domains to dashboard service
  - File: `apps/api/src/modules/admin/dashboard.service.ts` (extend)
...
- [x] 25. Add system health to dashboard service
  - File: `apps/api/src/modules/admin/dashboard.service.ts` (extend)
...
- [x] 26. Create audit service with logging and query methods
...
- [x] 27. Add audit export to audit service
...
- [x] 28. Add dashboard endpoints to controller
  - File: `apps/api/src/modules/admin/admin.controller.ts` (extend)
...
- [x] 29. Create admin auth Zustand store
...
- [x] 30. Create admin API client with auth methods
...
- [x] 30b. Add admin data API methods
...
- [x] 32. Create admin layout with auth check
...
- [x] 33. Create admin sidebar component
...
- [x] 34. Create admin header component
...
- [x] 35. Create dashboard page with metrics cards
...
- [x] 36. Add charts to dashboard page
...
- [x] 37. Create ScanTable component
...
- [x] 37b. Create scans list page with filters
...
- [x] 39. Create customers list page
...
- [x] 41b. Create admin users page with create dialog
...
- [x] 43. Create admin root page redirect
...
- [x] 44. Create admin service unit tests
...
- [x] 45. Create admin API integration tests
